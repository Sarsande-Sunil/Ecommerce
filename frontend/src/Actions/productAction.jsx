...
export const getAllReviews = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`/api/v1/reviewes?id=${id}`);
...
export const deleteReviews = (reviewId, productId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `/api/v1/reviewes?id=${reviewId}&productId=${productId}`
    );
...
// for all product error
export const clearAllProducterror = () => async (dispatch) => {
